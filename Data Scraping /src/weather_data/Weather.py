...
class Weather:
    ...
    def get_hourly_weather_1day(self, city, time):
        city_forecast = forecast(key=self.key, latitude=city.latitude, longitude=city.longitude, time=time)
    ...
    def get_hourly_weather(self, city, start, end, to_pandas=True):
        ...
        if to_pandas is True:
            ...
            weather_data['longitude'] = city.longitude
            weather_data['latitude'] = city.latitude
